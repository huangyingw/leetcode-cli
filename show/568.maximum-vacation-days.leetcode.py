...
# could take, but there are certain rules and restrictions you need to
# follow.
# 
# 
...
# of days[i][j], it represents the maximum days you could take vacation in the
...
# stay at city 0 for the whole 3 weeks. For each week, you only have one day to
# play and six days to work. So the maximum number of vacation days is 3.
# 
# 
# 
# Example 3:
